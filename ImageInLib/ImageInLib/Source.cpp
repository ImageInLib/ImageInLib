...
int main() {
	...
	//std::string loaded3D = outputPath + "loadedP1b.raw";
	...
	//computeDistanceMap(distanceMap3D, cropped, LengthNew, WidthNew, HeightNew, distanceParamerters, distMethod, seedPoint);
	//dataType secondCpuTime = clock() / (dataType)(CLOCKS_PER_SEC);
	//cout << "Execution time : " << secondCpuTime - firstCpuTime << endl;
	//std::string distance3D = outputPath + "distanceOld.raw";
	...
	//dataType firstCpuTime = clock() / (dataType)(CLOCKS_PER_SEC);
	//FastMarching3DNewVersion(imageData, distanceMap3D, potential, Length, Width, Height, seedP);
	//dataType secondCpuTime = clock() / (dataType)(CLOCKS_PER_SEC);
	//cout << "Execution time : " << secondCpuTime - firstCpuTime << endl;
	//std::string DistancePath = outputPath + "distanceP1b.raw";
	...
	//std::string ImagePath3D = outputPath + "resultPathP1b.raw";
