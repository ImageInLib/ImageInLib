...
int main() {
	...
	//fastMarching3d_N(imageData, distanceMap3D, potential3D, Length, Width, Height, seed);
	//std::string distance3D = outputPath + "potential.raw";
	//store3dRawData<dataType>(distanceMap3D, Length, Width, Height, distance3D.c_str());
