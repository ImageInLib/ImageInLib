...
void imageRegistration(void **movingImage, void **fixedImage, void **registeredImage, const size_t imageHeight, const size_t imageLength, const size_t imageWidth, registrationParams params, optimizationMethod optimization)
{
	switch (optimization)
	{
