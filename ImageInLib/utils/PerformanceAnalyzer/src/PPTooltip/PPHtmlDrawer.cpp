...
//		m_arrTableSizes.clear();
	...
	m_lfDefault.lfItalic = m_defStyle.bItalicFont > 0 ? true : false;
	m_lfDefault.lfStrikeOut = m_defStyle.bStrikeOutFont > 0 ? true : false;
	m_lfDefault.lfUnderline = m_defStyle.bUnderlineFont > 0 ? true : false;
...
void CPPHtmlDrawer::SetDefaultStyles(_STRUCT_CHANGESTYLE &)
{
