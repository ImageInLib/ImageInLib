...
#if defined(TCC_TARGET_SVM32) || defined(TCC_TARGET_SVM64)
                pe_header.opthdr.AddressOfEntryPoint = 0;
#else
...
#if defined(TCC_TARGET_X86_64) || defined(TCC_TARGET_SVM64)
#define REL_TYPE_DIRECT R_X86_64_64
#define R_XXX_THUNKFIX R_X86_64_PC32
#define R_XXX_RELATIVE R_X86_64_RELATIVE

#elif defined(TCC_TARGET_I386) || defined(TCC_TARGET_SVM32)
...
#if defined(TCC_TARGET_X86_64) || defined(TCC_TARGET_SVM64)
                *wp = addr | IMAGE_REL_BASED_DIR64<<12;
#else
        ...
        if (sym->st_shndx == SHN_UNDEF) {
            ...
            if (type == STT_FUNC) {
                ...
                if (offset) {
                    ...
                    p = (WORD*)section_ptr_add(text_section, 8);
                    *(BYTE*)p = SVMOPCODE_JMP_IND;
#if defined(TCC_TARGET_SVM64)
                    *(DWORD*)((BYTE*)p+1) = (DWORD)-4;
#endif
#else
...
#elif defined(TCC_TARGET_SVM32) || defined(TCC_TARGET_SVM64)
                    put_elf_reloc(symtab_section, text_section, 
                        offset + 1, R_XXX_THUNKFIX, is->iat_index);
#else
                    put_elf_reloc(symtab_section, text_section, 
