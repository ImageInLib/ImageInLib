...
#if defined(TCC_TARGET_SVM32) || defined(TCC_TARGET_SVM64)
#define FUNC_NATIVECALL	6
#define FUNC_NATIVETHISCALL	7
#endif
...
#if defined(TCC_TARGET_SVM32) || defined(TCC_TARGET_SVM64)
	int  gen_listing; /* if true, write code generatore listing */
    char *gen_listing_path; /* code generator listing output directory*/
#endif
};
...
PUB_FUNC void tcc_listing_code(int codelen, int symoffset, const char *asmfmt, ...);
