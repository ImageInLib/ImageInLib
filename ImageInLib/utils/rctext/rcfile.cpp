...
// Resource_C
//----------------------------------------
Resource_C::Resource_C(const wchar_t *pszName) 
{ 
	m_sName = pszName; 
}
...
// Accelerators_C
//----------------------------------------
Accelerators_C::Accelerators_C(const wchar_t *pszName, const wchar_t *pszOptions) 
	: Resource_C(pszName)
{
...
// Bitmap_C
//----------------------------------------
Bitmap_C::Bitmap_C(const wchar_t *pszName, const wchar_t *pszFileName) 
	: Resource_C(pszName)
{
...
// Cursor_C
//----------------------------------------
Cursor_C::Cursor_C(const wchar_t *pszName, const wchar_t *pszFileName) 
	: Resource_C(pszName)
{
	m_sFileName = pszFileName;
}
...
// Font_C
//----------------------------------------
Font_C::Font_C(const wchar_t *pszName, const wchar_t *pszFileName) 
	: Resource_C(pszName)
{
	m_sFileName = pszFileName;
}
...
// Icon_C
//----------------------------------------
Icon_C::Icon_C(const wchar_t *pszName, const wchar_t *pszFileName) 
	: Resource_C(pszName)
{
	m_sFileName = pszFileName;
}
...
// RCData_C
//----------------------------------------
RCData_C::RCData_C(const wchar_t *pszName) 
	: Resource_C(pszName)
{
}
...
// UserDef_C
//----------------------------------------
UserDef_C::UserDef_C(const wchar_t *pszName, const wchar_t *pszType) 
	: Resource_C(pszName)
{
	m_sType = pszType;
}
...
// Dialog_C
//----------------------------------------
Dialog_C::Dialog_C(const wchar_t *pszName, const wchar_t *pszType, const wchar_t *pszOptions) 
	: Resource_C(pszName)
	, m_sType(pszType)
	, m_sOptions(pszOptions)
{
...
const wchar_t* Dialog_C::GetOptions() 
{ 
	return m_sOptions.c_str(); 
}

const wchar_t* Dialog_C::GetType() 
{ 
	return m_sType.c_str(); 
}
...
// Control_C
//----------------------------------------
Control_C::Control_C(const wchar_t *pszType, const wchar_t *pszText, const wchar_t *pszID, const wchar_t *pszOptions)
{
	m_sType = pszType;
	m_sText = pszText;
	m_sID = pszID;
...
// Menu_C
//----------------------------------------
Menu_C::Menu_C(const wchar_t *pszName, const wchar_t *pszOptions) 
	: Resource_C(pszName)
{
	m_sOptions = pszOptions;
}
...
// MenuItem_C
//----------------------------------------
MenuItem_C::MenuItem_C(const wchar_t *pszText, const wchar_t *pszID, const wchar_t *pszOptions)
{
	m_sText = pszText;
	m_sID = pszID;
	m_sOptions = pszOptions;
...
// MenuPopup_C
//----------------------------------------
MenuPopup_C::MenuPopup_C(MenuPopup_C *pOwner, const wchar_t *pszText, const wchar_t *pszID, const wchar_t *pszOptions)
	: MenuItem_C(pszText, pszID, pszOptions)
{
	m_pOwner = pOwner;
}
...
const wchar_t* MenuPopup_C::GetText() 
{ 
	return m_sText.c_str(); 
}

const wchar_t* MenuPopup_C::GetID() 
{ 
	return m_sID.c_str(); 
}

const wchar_t* MenuPopup_C::GetOptions() 
{ 
	return m_sOptions.c_str(); 
}
...
// StringTable_C
//----------------------------------------
StringTable_C::StringTable_C(const wchar_t *pszOptions) 
	: Resource_C(L"")
{
	m_sOptions = pszOptions;
}
...
// String_C
//----------------------------------------
String_C::String_C(const wchar_t *pszID, const wchar_t *pszText)
{
	m_sText = pszText;
	m_sID = pszID;
}
...
// VersionInfo_C
//----------------------------------------
VersionInfo_C::VersionInfo_C(const wchar_t *pszName, const wchar_t *pszOptions) 
	: Resource_C(pszName)
{
	m_sOptions = pszOptions;
}
...
// Toolbar_C
//----------------------------------------
Toolbar_C::Toolbar_C(const wchar_t *pszName, const wchar_t *pszOptions) 
	: Resource_C(pszName)
{
	m_sOptions = pszOptions;
}
